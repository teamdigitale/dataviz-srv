...
export const ChartFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChartSelect> = z.object({
...
export const ChartFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    chart: z.boolean().optional(),
