...
export const SourceLinkFindFirstSelectSchema: z.ZodType<Prisma.SourceLinkSelect> = z.object({
...
export const SourceLinkFindFirstSelectZodSchema = z.object({
    dataSource: z.boolean().optional(),
    dataSourceId: z.boolean().optional(),
    chart: z.boolean().optional(),
    chartId: z.boolean().optional(),
...
export const SourceLinkFindFirstSchema: z.ZodType<Prisma.SourceLinkFindFirstArgs> = z.object({ select: SourceLinkFindFirstSelectSchema.optional(), include: z.lazy(() => SourceLinkIncludeObjectSchema.optional()), orderBy: z.union([SourceLinkOrderByWithRelationInputObjectSchema, SourceLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: SourceLinkWhereInputObjectSchema.optional(), cursor: SourceLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SourceLinkScalarFieldEnumSchema, SourceLinkScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SourceLinkFindFirstArgs>;

export const SourceLinkFindFirstZodSchema = z.object({ select: SourceLinkFindFirstSelectSchema.optional(), include: z.lazy(() => SourceLinkIncludeObjectSchema.optional()), orderBy: z.union([SourceLinkOrderByWithRelationInputObjectSchema, SourceLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: SourceLinkWhereInputObjectSchema.optional(), cursor: SourceLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SourceLinkScalarFieldEnumSchema, SourceLinkScalarFieldEnumSchema.array()]).optional() }).strict();