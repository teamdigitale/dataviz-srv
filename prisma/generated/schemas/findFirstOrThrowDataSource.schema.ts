...
export const DataSourceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DataSourceSelect> = z.object({
...
export const DataSourceFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    data: z.boolean().optional(),
...
export const DataSourceFindFirstOrThrowSchema: z.ZodType<Prisma.DataSourceFindFirstOrThrowArgs> = z.object({ select: DataSourceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DataSourceIncludeObjectSchema.optional()), orderBy: z.union([DataSourceOrderByWithRelationInputObjectSchema, DataSourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DataSourceWhereInputObjectSchema.optional(), cursor: DataSourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DataSourceScalarFieldEnumSchema, DataSourceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DataSourceFindFirstOrThrowArgs>;

export const DataSourceFindFirstOrThrowZodSchema = z.object({ select: DataSourceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DataSourceIncludeObjectSchema.optional()), orderBy: z.union([DataSourceOrderByWithRelationInputObjectSchema, DataSourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DataSourceWhereInputObjectSchema.optional(), cursor: DataSourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DataSourceScalarFieldEnumSchema, DataSourceScalarFieldEnumSchema.array()]).optional() }).strict();