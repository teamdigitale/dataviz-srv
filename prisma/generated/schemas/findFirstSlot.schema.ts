...
export const SlotFindFirstSelectSchema: z.ZodType<Prisma.SlotSelect> = z.object({
...
export const SlotFindFirstSelectZodSchema = z.object({
    dashboard: z.boolean().optional(),
    dashboardId: z.boolean().optional(),
    chart: z.boolean().optional(),
    chartId: z.boolean().optional(),
...
export const SlotFindFirstSchema: z.ZodType<Prisma.SlotFindFirstArgs> = z.object({ select: SlotFindFirstSelectSchema.optional(), include: z.lazy(() => SlotIncludeObjectSchema.optional()), orderBy: z.union([SlotOrderByWithRelationInputObjectSchema, SlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: SlotWhereInputObjectSchema.optional(), cursor: SlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SlotScalarFieldEnumSchema, SlotScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SlotFindFirstArgs>;

export const SlotFindFirstZodSchema = z.object({ select: SlotFindFirstSelectSchema.optional(), include: z.lazy(() => SlotIncludeObjectSchema.optional()), orderBy: z.union([SlotOrderByWithRelationInputObjectSchema, SlotOrderByWithRelationInputObjectSchema.array()]).optional(), where: SlotWhereInputObjectSchema.optional(), cursor: SlotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SlotScalarFieldEnumSchema, SlotScalarFieldEnumSchema.array()]).optional() }).strict();