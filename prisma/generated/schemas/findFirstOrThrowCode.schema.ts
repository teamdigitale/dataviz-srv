...
export const CodeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CodeSelect> = z.object({
...
export const CodeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    expire: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const CodeFindFirstOrThrowSchema: z.ZodType<Prisma.CodeFindFirstOrThrowArgs> = z.object({ select: CodeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CodeIncludeObjectSchema.optional()), orderBy: z.union([CodeOrderByWithRelationInputObjectSchema, CodeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CodeWhereInputObjectSchema.optional(), cursor: CodeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CodeScalarFieldEnumSchema, CodeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CodeFindFirstOrThrowArgs>;

export const CodeFindFirstOrThrowZodSchema = z.object({ select: CodeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CodeIncludeObjectSchema.optional()), orderBy: z.union([CodeOrderByWithRelationInputObjectSchema, CodeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CodeWhereInputObjectSchema.optional(), cursor: CodeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CodeScalarFieldEnumSchema, CodeScalarFieldEnumSchema.array()]).optional() }).strict();