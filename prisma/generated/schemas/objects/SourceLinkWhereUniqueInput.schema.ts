...
import { SourceLinkDataSourceIdChartIdCompoundUniqueInputObjectSchema as SourceLinkDataSourceIdChartIdCompoundUniqueInputObjectSchema } from './SourceLinkDataSourceIdChartIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  dataSourceId_chartId: z.lazy(() => SourceLinkDataSourceIdChartIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = [] as string[];
        const groups: string[][] = [["dataSourceId","chartId"]] as string[][];
...
export const SourceLinkWhereUniqueInputObjectSchema: z.ZodType<Prisma.SourceLinkWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.SourceLinkWhereUniqueInput>;
export const SourceLinkWhereUniqueInputObjectZodSchema = makeSchema();
